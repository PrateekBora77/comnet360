              ...
              <div className="space-y-4">
                ...
                <div className="pt-2 border-t border-slate-100 space-y-3">
                  <div className="flex items-center gap-3 py-2">
                    ...
                    <div>
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wide">Email (cannot be changed)</p>
                  ...
                  <div className="flex items-center gap-3 py-2">
                    ...
                    <div>
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wide">Role (set by admin)</p>
                      <p className="text-sm text-slate-500 mt-0.5">{user.role.replace(/_/g, ' ')}</p>
                    </div>
                  </div>
                </div>
              </div>
