            ...
            {notifications.map((n) => {
              ...
              return (
                <div
                  ...
                  className={`flex items-start gap-4 px-5 py-4 transition-colors ${isUnread ? 'bg-blue-50/50 dark:bg-blue-900/10' : 'hover:bg-slate-50 dark:hover:bg-slate-700/30'}`}
                >
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 ${isUnread ? 'bg-blue-100 dark:bg-blue-900/30' : 'bg-slate-100 dark:bg-slate-700'}`}>
                    {n.channel === 'EMAIL' ? (
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2">
                      <p className={`text-sm font-medium ${isUnread ? 'text-slate-900 dark:text-white' : 'text-slate-700 dark:text-slate-300'}`}>
                        {n.title}
            ...
            {[
              ...
              return (
                <label key={key} className="flex items-start justify-between gap-4 cursor-pointer group">
                  <div>
                    <p className="text-sm font-medium text-slate-800 dark:text-slate-100 group-hover:text-blue-600 transition-colors">{label}</p>
