...
const ROLES = [
  'ADMIN', 'SERVICE_MANAGER', 'OPERATIONS_HEAD',
...
const roleColors = {
  ...
  OPERATIONS_HEAD: 'blue',
  COMPLIANCE_OFFICER: 'cyan',
  NETWORK_ENGINEER: 'orange',
  ENTERPRISE_USER: 'slate',
};
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">{users?.length ?? 0} registered users</p>
        </div>
        {me?.role === 'ADMIN' && (
          <Button
            size="sm"
                ...
                <tr key={u.userId} className="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                  ...
                  <td className="px-5 py-3.5">
                    <div className="flex items-center gap-3">
                      <div className="w-7 h-7 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center text-blue-600 dark:text-blue-400 text-xs font-bold flex-shrink-0">
                  ...
                  {/* Role */}
                  <td className="px-5 py-3.5">
                    <Badge color={roleColors[u.role]}>{u.role.replace(/_/g, ' ')}</Badge>
                  </td>
                  {/* Status */}
                  <td className="px-5 py-3.5">
      ...
      >
        <div className="space-y-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-2 pr-10 text-sm border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
              />
              <button
                type="button"
          ...
          <p className="text-xs text-slate-400 bg-slate-50 rounded-lg px-3 py-2">
            The user will be able to log in immediately with these credentials. Their role can be changed later.
          </p>
        </div>
      </Modal>
